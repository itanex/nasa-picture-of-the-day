...
export interface Potd {
    ...
    hdurl: string, //"https://apod.nasa.gov/apod/image/2101/2020_12_16_Kujal_Jizni_Pol_1500px-3.png",
    media_type: string, // "image",
    service_version: string, // "v1",
    /** title of the image */
    title: string, //"Galaxies and the South Celestial Pole",
    /** Basic URL of the image */
    url: string, // "https://apod.nasa.gov/apod/image/2101/2020_12_16_Kujal_Jizni_Pol_1500px-3.jpg"
}
